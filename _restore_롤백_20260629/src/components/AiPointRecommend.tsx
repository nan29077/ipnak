...
import {
  ...
  ChevronRight, Loader2, Ruler, Search, Waves, Droplets,
} from "lucide-react";
...
type RecResult = { basis: string; broadened?: boolean; points: RecPoint[]; query: any };
    ...
    <>
      {variant === "bar" ? (
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-2xl bg-orange-500/95 px-3.5 py-3 text-[13px] font-semibold text-white shadow-card backdrop-blur btn-press transition-colors hover:bg-orange-600"
        >
          <Sparkles size={16} />
          AI 포인트 추천
        </button>
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center gap-1.5">
                  <img src={mp.author.avatarUrl || ""} alt="" className="h-4 w-4 rounded-full object-cover" />
