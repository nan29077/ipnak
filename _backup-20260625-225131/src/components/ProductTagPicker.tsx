  ...
  return (
    <div>
      <button type="button" onClick={() => setOpen(true)}
        className="flex w-full items-center justify-between rounded-xl border border-navy-100 bg-white px-3.5 py-3 text-sm text-navy-700 shadow-card transition-colors hover:bg-navy-50/40 btn-press">
        <span className="flex items-center gap-2 font-semibold"><ShoppingBag size={18} className="text-aqua-500" /> 쇼핑 태그 추가</span>
      ...
      <Sheet open={open} onClose={() => setOpen(false)} title="쇼핑 태그 선택">
