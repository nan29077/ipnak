    ...
    <div className="pb-10">
      ...
      <div className="flex items-center gap-4 px-5 py-6">
        {user.avatarUrl ? (
          ...
          <div className="flex h-[72px] w-[72px] items-center justify-center rounded-full bg-gradient-to-br from-navy-700 to-aqua-500 text-[28px] font-extrabold text-white shadow-aqua">
                ...
                <Card key={b.id} as="article" className="flex items-center gap-3 p-2.5" onClick={undefined}>
                  <Link href={`/reservations/${b.listingId}`} className="flex flex-1 items-center gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 text-xs text-navy-400">{reservationCategoryLabel(b.listing.category)} · {format(b.date, "M월 d일")} · {b.people}명 · {won(b.totalPrice)}</p>
                    </div>
