...
export function RecordingBanner() {
  ...
  return (
    <div className="sticky top-[52px] z-30 px-3.5 pt-2">
      <div className="mx-auto flex max-w-[640px] items-center gap-2.5 rounded-2xl border border-orange-500/30 bg-[#122030]/95 px-3.5 py-2.5 shadow-card backdrop-blur">
