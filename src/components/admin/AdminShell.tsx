...
import {
  ...
  Anchor, CalendarDays, ShoppingBag, Fish, SlidersHorizontal, Settings, Shield, LogOut, ExternalLink, Star, LayoutList, BadgeCheck,
} from "lucide-react";
...
const GROUPS: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/products", label: "피싱태그/상품", icon: ShoppingBag },
    ],
  },
  {
    title: "대회",
  ...
  },
  {
    title: "사이트 관리",
    items: [
      { href: "/admin/sections", label: "섹션 관리", icon: LayoutList },
