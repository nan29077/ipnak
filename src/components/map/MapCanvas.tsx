...
const COLORS: Record<string, string> = { current: "#2dd4bf", catch: "#243a63", listing: "#eab308" };
...
function createFishIcon(count: number, photoUrl?: string | null): L.DivIcon {
  ...
  return L.divIcon({
    html: `<div style="position:relative;width:36px;height:36px;">
      <div style="width:36px;height:36px;background:#eab308;border:2.5px solid white;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(0,0,0,0.4);overflow:hidden;">${inner}</div>
      ${badge}
    </div>`,
    className: "",
    iconSize: [36, 36],
