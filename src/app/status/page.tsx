export default function StatusPage() {
  return (
    <div style={{padding:"2rem",fontFamily:"sans-serif",background:"#111",color:"#fff",minHeight:"100vh"}}>
      <h1 style={{color:"#eab308",marginBottom:"1.5rem"}}>작업 완료 현황</h1>
      <div style={{background:"#162538",borderRadius:"12px",padding:"1.5rem",marginBottom:"1rem"}}>
      ...
      <div style={{background:"#162538",borderRadius:"12px",padding:"1.5rem"}}>
        <h2 style={{color:"#eab308",marginBottom:"1rem"}}>수동 실행 필요</h2>
