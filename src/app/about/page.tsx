...
const FEATURES: Feature[] = [
  {
    icon: Camera,
    title: "AI 카메라 계측",
    sub: "스마트폰으로 물고기 길이·어종을 AI로 측정",
    body: "입낚볼 또는 인쇄 기준물을 물고기 옆에 두고 촬영하면 AI가 자동으로 길이를 계산합니다. 같은 사진으로 어종까지 자동 인식해 알려주며, 결과가 다르면 직접 수정할 수 있습니다. 갤러리 사진도 측정 가능하며, 측정 기록은 자동으로 조행기와 연동됩니다.",
    color: "from-orange-500/80 to-orange-700/80",
    accent: "#eab308",
    features: ["실시간 AI 카메라 측정", "AI 어종 자동 인식", "갤러리 사진 측정", "몸통 너비·무게 추정", "측정 기록 자동 저장"],
  },
  {
    icon: CircleDot,
    title: "입낚볼",
    sub: "NFC 기술로 정밀 측정의 기준이 되는 스마트 볼",
    body: "40mm 진한 노랑 구체에 NFC 칩이 내장된 입낚 전용 계측 기준물입니다. 물고기 옆에 두고 촬영하면 AI가 볼의 크기를 기준으로 정확한 길이를 산출합니다. AI 측정에는 계정에 연동된 입낚볼 또는 입낚키링이 필요합니다.",
    color: "from-amber-500/80 to-orange-600/80",
    accent: "#eab308",
    features: ["NFC 태그로 볼 ID 연동", "AI 기준점 자동 인식", "40mm 구체 정밀 기준물", "연동 볼 기준 자동 계측"],
  },
  {
    icon: Route,
    title: "스마트피싱",
