    ...
    <div className="pb-10">
      ...
      <div className="p-4">
        ...
        <Card className="overflow-hidden p-0">
          <div className="bg-gradient-to-br from-orange-500 to-aqua-500 p-4">
            ...
            <Card className="divide-y divide-navy-50 overflow-hidden p-0">
              {approved.map((e, i) => (
                <div key={e.id} className="flex items-center gap-3 px-3 py-2.5">
                  ...
                  <Link href={`/profile/${e.user.id}`}><img src={getAvatarUrl(e.user.id, e.user.avatarUrl)} alt="" className="h-9 w-9 rounded-full object-cover" /></Link>
