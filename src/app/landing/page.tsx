...
const BASS_PC_CINEMAGRAPH_BACKGROUND = "/landing-bear-bass-boat-hero-ipnak-chest.png";
// OFF 상태 PC 배경 — 이전 버전(정중앙 배스 파이팅 컷)으로 복귀
const ALL_SPECIES_PC_BACKGROUND = "/landing-bear-bass-boat-hero-ipnak-chest.png";
